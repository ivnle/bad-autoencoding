...
class DeepseekOCRModel(DeepseekV2Model):
    ...
    def __init__(self, config: DeepseekV2Config, load_vision_encoder: bool = True):
...
class DeepseekOCRForCausalLM(DeepseekV2ForCausalLM):
    ...
    def __init__(self, config, load_vision_encoder: bool = True):
        super(DeepseekV2ForCausalLM, self).__init__(config)
        self.model = DeepseekOCRModel(config, load_vision_encoder=load_vision_encoder)
